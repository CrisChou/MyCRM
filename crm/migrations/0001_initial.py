# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-10-07 12:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_status', models.SmallIntegerField(choices=[(0, '缺勤'), (1, '已签到'), (2, '迟到'), (3, '早退')], default=None)),
        ...
        migrations.AddField(
            ...
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.CustomerInfo', verbose_name='客户对象'),
        ),
        migrations.AddField(
            model_name='customerfollowup',
            name='user',
