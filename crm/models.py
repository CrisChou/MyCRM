...
class CustomerInfo(models.Model):
    ...
    contact_type = models.SmallIntegerField(
        choices=contact_type_choices, default=0)
    contact = models.CharField(max_length=64, unique=True)
    source_choices = ((0, 'QQ群'), (1, '51CTO'), (2, '百度推广'), (3, '知乎'),
                      (4, '转介绍'), (5, '其他'), )
    source = models.SmallIntegerField(choices=source_choices)
    referral_from = models.ForeignKey(
        'self', blank=True, null=True, verbose_name='转介绍')
    ...
    emergency_contact = models.PositiveIntegerField(
        blank=True, null=True, verbose_name='紧急联系人')
    sex_choices = ((0, '男'), (1, '女'))
...
class ClassList(models.Model):
    ...
    class_type = models.SmallIntegerField(
        choices=class_type_choices, default=0)
...
class CustomerFollowUp(models.Model):
    """客户跟踪记录"""
    customer = models.ForeignKey(CustomerInfo, verbose_name='客户对象')
...
class StudyRecord(models.Model):
    ...
    score_choices = ((100, 'A+'), (90, 'A'), (85, 'B+'), (80, 'B'), (75, 'B-'),
                     (70, 'C+'), (60, 'C'), (40, 'C-'), (-50, 'D'), (0, 'N/A'),
                     (-100, 'COPY'))

    score = models.SmallIntegerField(choices=score_choices, default=0)
    show_choices = ((0, '缺勤'), (1, '已签到'), (2, '迟到'), (3, '早退'))
    show_status = models.SmallIntegerField(choices=show_choices, default=None)
...
class PaymentRecord(models.Model):
    ...
    payment_type = models.SmallIntegerField(
        choices=payment_type_choices, default=0)
